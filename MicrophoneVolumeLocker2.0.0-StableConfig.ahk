...
Gui, Font, , 
Gui, Font, , 
Gui, Add, Button, x532 y269 w170 h40 gkill, Kill Nircmd.exe
Gui, Add, Text, x502 y119 w230 h80 , Click the „Kill Nircmd.exe“ everytime you want to set a New volume lock because if you don't two instances of Nircmd.exe will run that have different Volume locks. They will interfere with each other and the Volume will jump all over the place.
; Generated using SmartGUI Creator 4.0
Gui, Show, x516 y243 h482 w776, Microphone Volume Locker 2.0.0
Return
